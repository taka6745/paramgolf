...
| STACK_FIREHOSE_LEGAL_TTT | - | normuon + gated_attention + asymmetric_skip_init + LEGAL_TTT (4-way COMBINATION) | yes (world-novel combination) | **n=1 PARTIAL FAIL — LEGAL_TTT NOT additive with 3-way** | S2 seed42=**1.4045** vs 3-way alone 1.40295 = **+0.0016 WORSE**; LEGAL_TTT only composes with BARE gated_attention (champion 1.3711), not with normuon+asym_skip stack. **Big finding: LEGAL_TTT requires minimal-stack ingredient model**; seed1337 in flight | +0.0016 vs 3-way | F | 20260408T1627Z |
...
| L11_infra | 4 | L11_KER_cudagraph_persistent | comp-novel placeholder (no patcher hunk) | **n=1 NEUTRAL — placeholder** | S2 seed42=**1.4145** vs baseline 1.4137 = +0.0008 WITHIN noise (no actual cudagraph code shipped, just gated_attention env); confirmed no-op | +0.0008 (cheap I n=1) NOOP | I | 20260408T1627Z |
