...
| L08_optimizer | 6 | L08_normuon | no (comp-port) | **confirmed-win, 2nd best single** | S2 seed42=1.4086 (n=1, seed1337 still queued) | 1.4086 (cheap B n=1) | B | 20260408T1112Z |
| STACK_TRUE_WINNERS_3WAY | - | normuon + gated_attention + asymmetric_skip_init | - | **★★★ NEW OVERALL BEST val_bpb of campaign (S2 cheap-pod)** | S2 seed42=**1.4080** ★★★★ (-0.0057 vs baseline 1.4137; -0.0006 vs normuon alone; n=1 seed1337 queued) | **1.4080** ★★★★ (cheap B n=1) | B | 20260408T1151Z |
...
| L07_loss | 5 | L07_byte_weight | no (comp-port) | **n=1 borderline — needs seed1337** | S2 seed42=**1.4143** > baseline 1.4137 by +0.0006 (within seed noise) — queued seed1337 on Pod C | n=1 +0.0006 (uncertain) | F | 20260408T1112Z |
