...
| STACK_GATED_LEGAL_TTT_LR2X | - | bare champion + LEGAL_TTT_LR=0.002 (vs default 0.001) — 2× learning rate | **comp-novel (PhD-defensible)** | **C90 1920Z queued** | hypothesis: complement to 5STEPS test on F. Doubles per-step LR; if 5STEPS works, LR2X tests whether step COUNT or step SIZE matters. Together they cover both LEGAL_TTT hyperparameters in parallel. n=2 for Pod J | pending | J | 20260408T1920Z |
...
| G2_gpu_idle_streak | 20260408T1932Z | 0 idle streaks (all 8 pods 85-100%); F picked STACK_GATED_LEGAL_TTT_5STEPS_seed1337 confirm; H=LN_SCALE 41min; LR2X in queue for J | 0 streaks >5s util<80% | PASS | 0 |
