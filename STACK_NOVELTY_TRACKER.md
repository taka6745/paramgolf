...
| STACK_MDL_LEGAL_TTT_GATED | - | mdl_compressible_first + LEGAL_TTT + gated_attention (3-way world-novel COMBINATION) | **yes (world-novel combination)** | **n=1 PARTIAL FAIL — confirms LEGAL_TTT brittleness** | S2 seed42=**1.4117** vs baseline 1.4137 = -0.002 (works), but vs LEGAL_TTT champion 1.3711 = **+0.0406 WORSE**. Adding L02 anti-curriculum to minimal champion HURTS; LEGAL_TTT requires bare gated only. seed1337 in flight | -0.002 vs baseline / +0.0406 vs champion | E | 20260408T1707Z |
...
| STACK_FIREHOSE_NORM_PCT | - | normuon + gated_attention + asymmetric_skip_init + L05_NORM_PCT_DROPOUT (4-way world-novel COMBINATION) | **yes (world-novel combination)** | **n=1 MARGINAL — additive small loss** | S2 seed42=**1.4061** vs baseline 1.4137 = -0.0076 (real win), but vs 3-way alone 1.40295 = **+0.003 WORSE**. NORM_PCT_DROPOUT adds noise to optimized 3-way. Composes weakly. seed1337 in flight | -0.0076 vs baseline / +0.003 vs 3-way | G | 20260408T1707Z |
...
| G2_gpu_idle_streak | 20260408T1722Z | 0 idle streaks (all 8 pods 85-100%); B STACK_GATED_NORM_PCT_LEGAL_TTT_seed42 30min in (eval phase); 3 NIGHT_MODE shots in flight | 0 streaks >5s util<80% | PASS | 0 |
