...
| TOKEN_FIREHOSE_3way | - | normuon + gated_attention + asymmetric_skip_init (= STACK_TRUE_WINNERS_3WAY, fresh seed) | - | **n=1 BEST single-run, seed42=1.4032** ★ | S2 seed42=**1.4032** vs baseline 1.4137 = **-0.0105** (10x bear-fruit threshold; beats prior 3WAY n=2 mean=1.40725 by -0.004); seed1337 in flight | **1.4032** ★ (cheap J n=1) | J | 20260408T1532Z |
...
| STACK_FIREHOSE_LEGAL_TTT | - | normuon + gated_attention + asymmetric_skip_init + LEGAL_TTT (4-way world-novel COMBINATION) | **yes (world-novel combination)** | **C90 1550Z queued** | hypothesis: TOKEN_FIREHOSE 3-way (1.4032 best single) + LEGAL_TTT champion ingredient (-0.04) → could break 1.367; n=2 seeds 42/1337 queued for Pod F (correctly flattened format) | pending | F | 20260408T1550Z |
