...
| STACK_FIREHOSE_NORM_PCT | - | normuon + gated_attention + asymmetric_skip_init + L05_NORM_PCT_DROPOUT (4-way world-novel COMBINATION) | **yes (world-novel combination)** | **C90 1620Z queued** | hypothesis: 3-way confirmed champion (1.40295) + L05_norm_pct_dropout confirmed world-novel (1.41365) → both individually validated, never combined; 50% comp efficiency → ~1.395 region; n=2 seeds 42/1337 for Pod G | pending | G | 20260408T1620Z |
...
| G2_gpu_idle_streak | 20260408T1642Z | 0 idle streaks (all 8 pods 90-100%); 3 NIGHT_MODE shots still in flight (E/F/G) | 0 streaks >5s util<80% | PASS | 0 |
