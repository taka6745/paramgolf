...
| STACK_GATED_NORM_PCT_LEGAL_TTT | - | gated_attention + L05_NORM_PCT_DROPOUT + LEGAL_TTT (3-way MINIMAL champion + new) | **yes (world-novel combination)** | **n=1 CONFIRMED FAIL — LEGAL_TTT brittle to ANY addition** | S2 seed42=**1.4153** vs baseline 1.4137 = +0.0016 (FAIL); vs LEGAL_TTT champion 1.3711 = **+0.0442 WORSE**. Even ONE ingredient stacked with LEGAL_TTT hurts. **CONFIRMED: LEGAL_TTT champion is fundamentally brittle to all additions tested (L02_anti-curriculum, L05_norm_pct, normuon+asym_skip)**. seed1337 in flight | +0.0442 vs champion | B | 20260408T1727Z |
...
| G2_gpu_idle_streak | 20260408T1748Z | 0 idle streaks (all 8 pods 87-100%); B/J still on NIGHT_MODE shots; G cycled to MS2; champion 1.3711 unchanged | 0 streaks >5s util<80% | PASS | 0 |
