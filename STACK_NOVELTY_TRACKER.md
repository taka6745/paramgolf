...
| L08_optimizer | 3 | L08_per_proj_lr_split | **yes (world-novel)** | **n=2 confirmed-win** (S2 cheap-pod) | S2 seed42=1.4166 + seed1337=1.4148 → mean=**1.4157** | **1.4157** (cheap B n=2) | B | 20260408T1145Z |
...
| L07_loss | 4 | L07_asym_label_smoothing | **yes (world-novel)** | **n=2 confirmed-win** (S2 cheap-pod) | S2 seed42=1.4138 + seed1337=1.4144 → mean=**1.4141** | **1.4141** (cheap F n=2) | F | 20260408T1145Z |
| L05_ffn | 3 | L05_parallel_residuals | no (comp port) | **confirmed-win** (S2 cheap-pod) | seed42 → val_bpb=1.4235 (worst confirmed; world-novels beat by -0.013) |  | F | 20260408T1145Z |
