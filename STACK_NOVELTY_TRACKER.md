...
| STACK_BACKOFF_GATED | - | gated_attention + NGRAM_BACKOFF (cross-layer L04+L09 WITHOUT LEGAL_TTT) | **yes (world-novel combination)** | **in-flight Pod I (started 1754Z)** | hypothesis: control test for cross-layer compositionality WITHOUT the brittle LEGAL_TTT ingredient. Both gated_attention (1.4094) + NGRAM_BACKOFF (1.4122) confirmed wins | pending | I | 20260408T1750Z |
