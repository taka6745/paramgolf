...
| STACK_MDL_LEGAL_TTT_GATED | - | mdl_compressible_first + LEGAL_TTT + gated_attention (3-way world-novel COMBINATION, never tested together) | **yes (world-novel combination)** | **in-flight Pod E (started 1524Z)** | hypothesis: L02 anti-curriculum (1.4093) + champion stack (1.3711) compose to 1.36-1.37 region; seed42 in flight, seed1337 queued | pending | E | 20260408T1521Z |
| TOKEN_FIREHOSE_3way | - | normuon + gated_attention + asymmetric_skip_init (= STACK_TRUE_WINNERS_3WAY, fresh seed) | - | **★ n=2 confirmed-win mean=1.40295** | S2 seed42=1.4032 + seed1337=**1.4027** → mean=**1.40295** (Δ-0.0107 vs baseline; **BEST 3-way confirmed**, beats prior 3WAY n=2 mean=1.40725 by -0.0043) | **1.40295** ★ (cheap J n=2) | J | 20260408T1602Z |
...
| STACK_FIREHOSE_NORM_PCT | - | normuon + gated_attention + asymmetric_skip_init + L05_NORM_PCT_DROPOUT (4-way world-novel COMBINATION) | **yes (world-novel combination)** | **in-flight Pod G (started 1631Z)** | hypothesis: 3-way confirmed champion (1.40295) + L05_norm_pct_dropout confirmed world-novel (1.41365); compositional gain target 1.385-1.395 | pending | G | 20260408T1620Z |
...
| G2_gpu_idle_streak | 20260408T1652Z | 0 idle streaks (all 8 pods 100%); B picked XSA1 just before C90 1650Z push, will pick STACK_GATED_NORM_PCT_LEGAL_TTT next | 0 streaks >5s util<80% | PASS | 0 |
