...
| STACK_GATED_NORM_PCT_LEGAL_TTT | - | gated_attention + L05_NORM_PCT_DROPOUT + LEGAL_TTT (3-way MINIMAL champion + new) | **yes (world-novel combination)** | **C90 1650Z queued** | hypothesis: LEGAL_TTT brittle to ingredient additions (proved by FIREHOSE FAIL); test ADD ONLY ONE world-novel (NORM_PCT) to MINIMAL champion stack; if composes, target 1.366-1.370 (BEAR-FRUIT THRESHOLD); n=2 seeds for Pod B | pending | B | 20260408T1650Z |
...
| G2_gpu_idle_streak | 20260408T1713Z | 0 idle streaks (all 8 pods 100%); B STACK_GATED_NORM_PCT_LEGAL_TTT_seed42 21min in (lands ~1722Z); 3 NIGHT_MODE shots in flight | 0 streaks >5s util<80% | PASS | 0 |
