...
| 04:03 | 🔥 **TRAINING SEED 314** | Step **4030**, train_loss 2.90, val_bpb **1.1093** at step 4000 (seed 42 was 1.1095 — identical trajectory). 8.7/9.8 min wallclock. All GPUs 100%. ETA seed 314 eval done **~04:15Z**. Spend ~$48. |
| 04:13 | ⭐ **SEED 314 EVAL** | pre-quant **1.08942** (↓ better than s42), quant **1.09969**, sliding **1.08273** (↓ better), **TTT running** (~5 min left). Steps 4452. Artifact 16,050,433 (still ~50 KB over). Very low seed variance. Spend ~$51. |
| 04:23 | 🔥 **SEED 999 TRAINING** | Step **3140**, train_loss 3.03, 6.4 min wallclock. Post-looping (tok/s 6.4M). Seed 314 TTT done (result scrolled past log window). ~3.4 min to wallclock cap, then ~10 min eval. **ETA ALL DONE ~04:37Z.** Spend ~$55. |
...
| 03:53 | ⭐ **SEED 42 DONE** | pre-quant **1.08982**, quantized **1.10014**, sliding **1.08327**, **quantized_ttt 1.08243** ⭐ (only +0.0014 behind PR #1493!). **BUT artifact 16,051,299 bytes = 51 KB OVER 16 MB cap.** int6 quant gap 0.010 (vs PR #1493's 0.012 — OURS IS BETTER). Steps: 4448. GPTQ 13s. TTT eval 365s. Need dedup or other fix to shave 51 KB. Seeds 314/999 running for 3-seed mean. Spend ~$44. |
