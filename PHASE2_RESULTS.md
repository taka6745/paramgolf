...
| **E24_extreme (NUM_LAYERS=6 + MLP_MULT=2)** | 1×RTX 3090 24GB | 108.8s train + ~7 min wallclock | **150 train** (wallclock cap) | **725 ms/step** (**+15% vs E21, +47% vs E13**) | **15.2M params (-58% vs E6!)**, 260K+ tok/s | pre-quant **2.97149** / quant **3.13132** (gap 0.16) | tbd | **🏆🏆 4.05× vs E1 (NEW BEST, >4× crossed!)** | 🏆 **NEW CHAMPION, FIRST PAST 4×!** 6 layers + halved MLP = tiny model (15M). 150 training steps in 108s — MORE THAN 4× E1's 37. Pre-quant val_bpb 2.971 still under 3.0. Quant gap wider (0.16) but pre-quant quality excellent. Proves smaller = better at compute-budget limit. | 20260409T1724Z |
