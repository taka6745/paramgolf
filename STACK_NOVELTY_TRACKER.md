...
| L02_data | 2 | L02_mdl_compressible_first (BEC_REVERSE=1, MDL anti-curriculum, world-novel-candidate) | **yes (world-novel C30 1212Z)** | **in-flight** | C90 build 1232Z: queued 2 seeds via existing DAT_BYTE_ENTROPY_CURRICULUM_MARKER infra (BEC_REVERSE flag) — no new marker bloat | TBD | E | 20260408T1232Z |
...
| STACK_LEGAL_TTT | - | 5-way (gated + norm_pct + asym_skip + asym_label + per_proj_lr) **+ LEGAL_TTT (eval-time per-batch SGD K=3 LR=0.001)** | - | **🔥🔥🔥 NEW ALL-TIME CHAMPION (S2 cheap-pod)** | S2 seed42=**1.3726** ★★★★★ (-0.0346 vs 3-way 1.40725, -0.0411 vs baseline 1.4137; biggest single jump of campaign; LEGAL_TTT contributes ~-0.04 alone; n=1 seed1337 queued) | **1.3726** 🔥🔥🔥 (cheap G n=1) | G | 20260408T1212Z |
