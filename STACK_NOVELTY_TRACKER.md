...
| STACK_GATED_LEGAL_TTT_5STEPS | - | bare champion + LEGAL_TTT_STEPS=5 (vs default 3) — direct hyperparameter tuning | **comp-novel (PhD-defensible)** | **in-flight Pod F (started 1856Z)** | hypothesis: champion 1.3711 uses LEGAL_TTT_STEPS=3 default; bumping to 5 gives 67% more SGD steps. Could push below 1.3666 if eval under-converged | pending | F | 20260408T1850Z |
...
| G2_gpu_idle_streak | 20260408T1922Z | 0 idle streaks (all 8 pods 100%); 2 NIGHT_MODE shots active (F=5STEPS 26min, H=LN_SCALE 31min); J cycled to CHAMP_L4 | 0 streaks >5s util<80% | PASS | 0 |
