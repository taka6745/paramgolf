...
| STACK_FIREHOSE_LEGAL_TTT | - | normuon + gated_attention + asymmetric_skip_init + LEGAL_TTT (4-way world-novel COMBINATION) | **yes (world-novel combination)** | **in-flight Pod F (started 1552Z, lands ~1617Z)** | hypothesis: TOKEN_FIREHOSE 3-way (1.4032 best single) + LEGAL_TTT champion ingredient (-0.04) → could break 1.367 | pending | F | 20260408T1550Z |
...
| G2_gpu_idle_streak | 20260408T1617Z | 0 idle streaks (all 8 pods 96-100%); F STACK_FIREHOSE_LEGAL_TTT 25min in (lands imminent) | 0 streaks >5s util<80% | PASS | 0 |
